<?php
    ...
    $title = 'NẠP ATM/MOMO TỰ ĐỘNG| '.$CMSNAV->site('tenweb');
                        ...
                        <div>
                            <div class="border-t border-gray-200 mt-2 p-2 select-text">
                                <div class="relative">
                                    ...
                                    <?php foreach($CMSNAV->get_list("SELECT * FROM `bank` ") as $bank) { ?>
                            ...
                            <div class="border-t border-gray-200 w-full select-text">
                                <div class="p-2">
                                    ...
                                    <div class="my-2 items-center w-full text-center"><span
                                            ...
                                            <b id="copyNoiDung"><?=$CMSNAV->site('noidung_naptien').$getUser['id'];?></b>
