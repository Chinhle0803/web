                            ...
                            <form id="formSubmit" class="tw-max-w-sm form_data" method="POST" >
                                <div class="tw-mb-2">
                                    ...
                                    <div class="tw-mb-2">
                                        ...
                                        <?php foreach($CMSNAV->get_list("SELECT * FROM `groups_gamepass` WHERE `category` = '".$row['id']."' ") as $group) {?>
			   ...
			   <div class="tw-p-2 md:tw-p-4 overflow-x-auto">
				  <table id="datatable" class="tw-w-full tw-rounded-t ">
					 ...
					 <tbody class="bg-white tw-border tw-border-t-0 tw-rounded">
							<?php $i = 0; foreach($CMSNAV->get_list(" SELECT * FROM `orders_gamepass` WHERE `username` = '".$getUser['username']."' ORDER BY id DESC ") as $row){ ?>
                                <tr>
