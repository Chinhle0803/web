<?php
    ...
    $title = 'CHỈNH SỬA TÀI KHOẢN | '.$CMSNAV->site('tenweb');
...
{
    $row = $CMSNAV->get_row(" SELECT * FROM `accounts` WHERE `id` = '".check_string($_GET['id'])."' AND `receiver` = '".$getUser['username']."' ");
    if(!$row)
    {
