<?php
    ...
    $title = 'LƯU TRỮ | '.$CMSNAV->site('tenweb');
...
<div class="wrapper">
     ...
     <div class="page-inner">
          ...
          <button type="button" class="btn btn-success btn-floated">
              <span class="fa fa-plus"></span></button> <!-- /floating action --> <!-- title and toolbar --> <div class="d-md-flex align-items-md-start"> <h1 class="page-title mr-sm-auto"> Thêm Mục Lưu Trữ</h1> 
              
              <div id="dt-buttons" class="btn-toolbar"></div> </div> </header> 
