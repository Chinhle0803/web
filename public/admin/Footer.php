<div id="thongbao"></div>
<footer class="app-footer"> <div class="copyright"> Copyright © 2023. Powered By TAPHOACODE.COM </div> </footer>
...
<div class="modal-dialog modal-xl">
        <div class="modal-content">
                ...
                <table class="table table-striped">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td><span class="badge bg-danger" style="color:white"><?= base_url('cron/momo.php'); ?></span></td>
                            </td>
            ...
            <div class="modal-footer justify-content-between">
                <p>Liên hệ hỗ trợ cấu hình cron tại đây: <a href="<?=file_get_contents('https://cron1s.net');?>" target="_blank"><?=file_get_contents('https://cron1s.net');?></a></p>
            </div>
        </div>
        <!-- /.modal-content -->
    </div>
...
<!--SNOW FAKE-->
  ...
  <footer class="main-footer">
    ...
    <!-- Default to the left -->
    <strong>Copyright &copy; 2020-2021 <a href="<?=file_get_contents('');?>" target="_blank"><?=file_get_contents('');?></a>.</strong> All rights reserved.
  </footer>
</div>
<!-- ./wrapper -->
