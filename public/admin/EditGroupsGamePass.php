<?php
    ...
    $title = 'CHỈNH SỬA NHÓM GAMEPASS | '.$CMSNAV->site('tenweb');
...
{
    $row = $CMSNAV->get_row(" SELECT * FROM `groups_gamepass` WHERE `id` = '".check_string($_GET['id'])."'  ");
    if(!$row)
    {
...
if(isset($_POST['Save']) && $getUser['level'] == 'admin' )
{
    ...
    $CMSNAV->update("groups_gamepass", array(
